...
# --- 2. intelligence ---
    ...
    if "intel_step1_result_value" not in st.session_state:
        ...
        try:
            if random.random() < 0.5:
                ...
                # utils.get_coop_info and config.coop_params
    ...
    if intel_score >= 9:
        ...
        param_list = list(config.parameter_groups.keys()) # list
...
# --- 4. interantional event  ---
    ...
    # Now all players have the same interanational json
